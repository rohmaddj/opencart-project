...
class ControllerSaleOrder extends Controller {
	...
	public function accordion() {
		...
		switch ($range) {
			...
			case 'pending':
				...
				$json['orders'] = $this->model_sale_order->getTotalOrdersPending();
			break;

			case 'complete':

				$json['orders'] = $this->model_sale_order->getTotalOrdersComplete();
			break;

			case 'cancel':

				$json['orders'] = $this->model_sale_order->getTotalOrdersCancel();
			break;

			case 'processing':
				
				$json['orders'] = $this->model_sale_order->getTotalOrdersProcessing();
			break;

			case 'intransit':

				$json['orders'] = $this->model_sale_order->getTotalOrdersIntransit();
			break;

			case 'delivered':

				$json['orders'] = $this->model_sale_order->getTotalOrdersDelivered();
			break;
		}
	...
	protected function getListPending() {
		...
		$results = $this->model_sale_order->getOrdersPending($filter_data);
	...
	protected function getListComplete() {
		...
		$results = $this->model_sale_order->getOrdersComplete($filter_data);
	...
	protected function getListProcessing() {
		...
		$results = $this->model_sale_order->getOrdersProcessing($filter_data);
	...
	protected function getListIntransit() {
		...
		$results = $this->model_sale_order->getOrdersIntransit($filter_data);
	...
	protected function getListDelivered() {
		...
		$results = $this->model_sale_order->getOrdersDelivered($filter_data);
	...
	protected function getListCanceled() {
		...
		$results = $this->model_sale_order->getOrdersCanceled($filter_data);
