		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'operation/order')) {
				$operation[] = array(
					...
					'href'		=> $this->url->link('opeation/order', 'token=' . $this->session->data['token'], true),
					'children'	=> array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'operation/deliverypickup')) {
				$operation[] = array(
					...
					'href'		=> $this->url->link('opeation/deliverypickup', 'token=' . $this->session->data['token'], true),
					'children'	=> array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'operation/userroles')) {
				$operation[] = array(
					...
					'href'		=> $this->url->link('opeation/userroles', 'token=' . $this->session->data['token'], true),
					'children'	=> array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'operation/finance')) {
				$operation[] = array(
					...
					'href'		=> $this->url->link('opeation/finance', 'token=' . $this->session->data['token'], true),
					'children'	=> array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'operation/email')) {
				$operation[] = array(
					...
					'href'		=> $this->url->link('opeation/email', 'token=' . $this->session->data['token'], true),
					'children'	=> array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'operation/gallery')) {
				$operation[] = array(
					...
					'href'		=> $this->url->link('opeation/gallery', 'token=' . $this->session->data['token'], true),
					'children'	=> array()
				);
			}
