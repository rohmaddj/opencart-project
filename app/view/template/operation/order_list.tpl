...
<ul class="nav nav-tabs nav-tabs-justified" id="accordion-operation">
  <li value="pending">
    <a href="index.php?route=operation/order/indexPending&token=<?php echo $token; ?>"  style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="hidden-xs">Pending</span>
    </a>
  </li>
  <li value="complete">
    <a href="index.php?route=operation/order/indexComplete&token=<?php echo $token; ?>" style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="hidden-xs">Complete</span>
    </a>
  </li>
  <li value="processing">
    <a href="index.php?route=operation/order/indexProcessing&token=<?php echo $token; ?>" style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="hidden-xs">Processing</span>
    </a>
  </li>
  <li value="intransit">
    <a href="index.php?route=operation/order/indexIntransit&token=<?php echo $token; ?>" style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="hidden-xs">In-Transit</span>
    </a>
  </li>
  <li value="delivered">
    <a href="index.php?route=operation/order/indexDelivered&token=<?php echo $token; ?>" style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="visible-xs"><i class="fa-bell-o"></i></span>
      <span class="hidden-xs">Delivered</span>
    </a>
  </li>
  <li value="canceled">
    <a href="index.php?route=operation/order/indexCanceled&token=<?php echo $token; ?>" style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="visible-xs"><i class="fa-bell-o"></i></span>
      <span class="hidden-xs">Canceled</span>
    </a>
  </li>
  <li class="active">
    <a href="index.php?route=operation/order&token=<?php echo $token; ?>" style="margin: 0px;padding: 10px 5px 10px 5px">
      <span class="visible-xs"><i class="fa-bell-o"></i></span>
      ...
      <div class="panel-body">
        ...
        <div class="col-xs-3">
          <select name="filter_order_status" class="form-control input-sm">
            ...
            <option value="6"><a href="pos">Point-of-operations</a></option>
        </select>
        </div>
        ...
        <div class="col-xs-3">
          <select id="range1" class="form-control input-sm">
            ...
            <option value="pos"><a href="pos">Point-of-operations</a></option>
        </select>
        </div><div class="col-md-12" style="text-align: right;">
          <a href="index.php?route=operation/order&token=<?php echo $token; ?>"> 
...
<!--   <script type="text/javascript">
    function orderStatusAction(type) {
      ...
      $.ajax({
        type: 'get',
        url: 'index.php?route=operation/order/accordion&token=<?php echo $token; ?>&accordion-operation=' + type,
        dataType: 'json',
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=operation/order&token=<?php echo $token; ?>';
